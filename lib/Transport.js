...
module.exports = class Transport
{
  constructor(sockets, recovery_options = C.recovery_options)
  {
    ...
    {
      console.log(`cannot use TextDecoder: ${error}`);
    }
  ...
  connect()
  {
    ...
    if (this.isConnected())
    {
      console.log('Transport is already connected');
  ...
  send(data)
  {
    ...
    if (!this.isConnected())
    {
      console.log('unable to send message, transport is not connected');
  ...
  _reconnect()
  {
    ...
    console.log(`reconnection attempt: ${this.recover_attempts}. next connection attempt in ${k} seconds`);
  ...
  _onData(data)
  {
    ...
    if (data === '\r\n')
    {
      console.log('received message with CRLF Keep Alive response');
    ...
    else if (typeof data !== 'string')
    {
      ...
      {
        console.log('received binary message failed to be converted into string,' +
              ' message discarded');
