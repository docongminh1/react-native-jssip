    ...
    Promise.resolve()
      ...
      .then((stream) =>
      {
        ...
        if (stream)
        {
          ...
          console.log('this._connection checkkkk', this._connection)
          ...
          // this._connection.onaddstream = e => { console.log('remtoe stream checkkkk', e.stream) }
    ...
    Promise.resolve()
      ...
      .then((stream) =>
      {
        ...
        if (stream)
        {
          ...
          this._getLocalStreams(stream)
          this._connection.onaddstream = e => this._getRemoteStreams(e.stream)
          // this._connection.onaddstream = e => { console.log('remote stream checkkkk', e.stream) }
